...
bench_rayon!(rayon_t2_n40k_m400k, 2, 40_000, 400_000);
bench_rayon!(rayon_t4_n40k_m400k, 4, 40_000, 400_000);
bench_rayon!(rayon_t6_n40k_m400k, 6, 40_000, 400_000);
bench_rayon!(rayon_t8_n40k_m400k, 8, 40_000, 400_000);
// bench_rayon!(rayon_t12_n40k_m400k, 12, 40_000, 400_000);
// bench_rayon!(rayon_t16_n40k_m400k, 16, 40_000, 400_000);
// bench_rayon!(rayon_t20_n40k_m400k, 20, 40_000, 400_000);
// bench_rayon!(rayon_t24_n40k_m400k, 24, 40_000, 400_000);
// bench_rayon!(rayon_t28_n40k_m400k, 28, 40_000, 400_000);
// bench_rayon!(rayon_t32_n40k_m400k, 32, 40_000, 400_000);

// bench_rayon!(rayon_t1_n40k_m4m, 1, 40_000, 4_000_000);
// bench_rayon!(rayon_t2_n40k_m4m, 2, 40_000, 4_000_000);
// bench_rayon!(rayon_t4_n40k_m4m, 4, 40_000, 4_000_000);
// bench_rayon!(rayon_t6_n40k_m4m, 6, 40_000, 4_000_000);
// bench_rayon!(rayon_t8_n40k_m4m, 8, 40_000, 4_000_000);
// bench_rayon!(rayon_t12_n40k_m4m, 12, 40_000, 4_000_000);
// bench_rayon!(rayon_t16_n40k_m4m, 16, 40_000, 4_000_000);
// bench_rayon!(rayon_t20_n40k_m4m, 20, 40_000, 4_000_000);
// bench_rayon!(rayon_t24_n40k_m4m, 24, 40_000, 4_000_000);
// bench_rayon!(rayon_t28_n40k_m4m, 28, 40_000, 4_000_000);
