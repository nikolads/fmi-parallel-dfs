...
// bench!(unsafe_par_n4k_m400k_t1, unsafe_par, 1, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t2, unsafe_par, 2, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t4, unsafe_par, 4, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t6, unsafe_par, 6, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t8, unsafe_par, 8, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t10, unsafe_par, 10, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t12, unsafe_par, 12, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t14, unsafe_par, 14, 4_000, 400_000);
// bench!(unsafe_par_n4k_m400k_t16, unsafe_par, 16, 4_000, 400_000);
...
// bench!(spin_lock_rev_n4k_m400k_t1, spin_lock_rev, 1, 4_000, 400_000);
// bench!(spin_lock_rev_n4k_m400k_t2, spin_lock_rev, 2, 4_000, 400_000);
// bench!(spin_lock_rev_n4k_m400k_t4, spin_lock_rev, 4, 4_000, 400_000);
// bench!(spin_lock_rev_n4k_m400k_t6, spin_lock_rev, 6, 4_000, 400_000);
// bench!(spin_lock_rev_n4k_m400k_t8, spin_lock_rev, 8, 4_000, 400_000);
